...
class Agent:
    ...
    tools = [
        ...
        # create a tool to call the implementation agent
        {
            "type": "function",
            "function": {
                "name": "callImplementationAgent",
                "description": "Call the implementation agent to implement the plan.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "milestone": {
                            "type": "string",
                            "description": "The milestone to implement.",
                        },
                    },
                    "required": ["milestone"],
                    "additionalProperties": False,
    ...
    def __init__(self, name, client, prompt="", implementation_agent=None, gen_kwargs=None):
        self.name = name
        self.client = client
        self.prompt = prompt
